...
public:
  ...
  double cosineDistanceBetweenSolutionsInObjectiveSpace(Solution * solution1,
                                                        Solution * solution2,
                                                        ReferencePoint * referencePoint);
  void crowdingDistanceAssignment(SolutionSet * solutionSet, int nObjs);
  void cosineDistanceAssignment(SolutionSet * solutionSet, int nObjs, ReferencePoint * referencePoint);
  
private:
  double sumOfDistancesToIdealPoint(Solution * solution, ReferencePoint * referencePoint);
